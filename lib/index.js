...
const resources = module.exports = {
    ...
    hooks: {
    	'page:before': function (page) {
            ...
            page.content = page.content.replace(/\.\/([\s\S]+)\.png/g, prefix + '$1.png');
            page.content = page.content.replace(/\.\/([\s\S]+)\.gif/g, prefix + '$1.gif');
            page.content = page.content.replace(/\.\/([\s\S]+)\.jpg/g, prefix + '$1.jpg');
            page.content = page.content.replace(/\.\/([\s\S]+)\.jpeg/g, prefix + '$1.jpeg');
